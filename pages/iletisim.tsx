              ...
              >
                ...
                <div className="relative mt-8 h-64 bg-gradient-to-br from-purple-600 via-blue-600 to-indigo-700 rounded-3xl overflow-hidden shadow-xl">
                  ...
                  <div className="relative flex flex-col items-center justify-center h-full text-white p-6">
                    <div className="w-24 h-24 bg-white/20 backdrop-blur-xl rounded-full flex items-center justify-center mb-4 border border-white/30 overflow-hidden">
                      <Image src="/images/gs-logo.png" alt="Global Shapers Izmir Hub" width={72} height={72} className="object-contain" />
                    </div>
